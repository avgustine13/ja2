...
//	gp12PointArialFixedFont = LoadFontFile( "FONTS\\Arial12FixedWidth.sti" );
  ...
  // ATE: Init WinFont System and any winfonts we wish...
	...
	#else
		//giSubTitleWinFont = CreateWinFont( -16, 0, 0,  0, FALSE, FALSE, FALSE, L"јР·ўЕй", CHINESEBIG5_CHARSET );
		giSubTitleWinFont = CreateWinFont( -16, 0, 0,  0, FALSE, FALSE, FALSE, L"·sІУ©ъЕй", CHINESEBIG5_CHARSET );
		SET_USE_WINFONTS( TRUE );
